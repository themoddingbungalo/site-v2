...
export function ChevronDownIcon({ size = 14, className, stroke = 'currentColor' }: IconProps) {
  return (
    <svg {...strokeProps(size, stroke, 2.2)} className={className} aria-hidden="true">
...
/** Valve's Steam mark, from the CC0 simple-icons set. Used to identify the platform. */
export function SteamIcon({ size = 17, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
