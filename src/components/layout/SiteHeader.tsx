...
import { asset, contributeUrl, ext, site } from '../../data/site'
...
function buildIndex(): SearchEntry[] {
  ...
  out.push({ label: 'Contribute to the Wiki', tag: 'GitHub', to: contributeUrl, external: true })
            ...
            <div data-menu className={styles.menu}>
              ...
              {menu === 'community' && (
                <div className={styles.dropdown} style={{ minWidth: 232 }}>
                  ...
                  <a href={contributeUrl} {...ext} className={styles.plainItem}>Contribute to the Wiki</a>
                </div>
              )}
            </div>
          </nav>
        ...
        {drawer && (
          <div className={styles.drawer}>
            ...
            <div className={styles.drawerGroup}>
              ...
              <a href={contributeUrl} {...ext} className={styles.drawerLink}>Contribute to the Wiki</a>
            </div>
          </div>
        )}
      </header>
