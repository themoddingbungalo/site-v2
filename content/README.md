...
**If you would rather not edit it yourself**, open an issue instead. **Contribute to the
Wiki**, at the bottom of every page and in the header, opens three forms — report a bug in
the site, report wrong information or a typo in a page, or offer a guide you have written.
Fill one in and the person who owns that page picks it up. Install problems and crashes
are not issues: those go to the Discord.
